                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="member_picture" id="member_picture_inp" accept=".jpg, .png, .webp, .jpeg, .jfif" class="form-control shadow-none" required>
                                    </div>
                                </div>
                                <div class="modal-footer">
